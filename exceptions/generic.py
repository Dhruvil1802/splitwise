...
class CustomNotFound(GenericException):
    def __init__(self, message=None,data=None,code=status.HTTP_404_NOT_FOUND,*args,**kwargs):
        super().__init__(message, data, code, *args, **kwargs)
...
class CustomAuthenticationFailed(GenericException):
    def __init__(self, message=None,data=None,code=status.HTTP_401_UNAUTHORIZED,*args,**kwargs):
        super().__init__(message, data, code, *args, **kwargs)
...
class CustomPermissionDenied(GenericException):
    def __init__(self, message=None,data=None,code=status.HTTP_403_FORBIDDEN,*args,**kwargs):
        super().__init__(message, data, code, *args, **kwargs)
